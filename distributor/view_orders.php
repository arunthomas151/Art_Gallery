...
$sqlorder="select * from booking where distributor='$cname' and status='booked'";
         ...
         <td><?php echo $row1->date;?></td>
           <td><?php echo $row1->customer_id?></td> 
            ...
            <?php
             ...
             if($row1->confirm=='1')
             {
            ?><td><span class="badge badge-danger">Ordered to admin</span></td>
            <?php
             }
             else if($row1->confirm=='2')
             {
            ?><td><span class="badge badge-danger">Order Ready</span></td>
            <?php
             }
            ?>
